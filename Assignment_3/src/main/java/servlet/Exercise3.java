...
public class Exercise3 extends HttpServlet {
    ...
    private void displayError(HttpServletRequest request, HttpServletResponse response, String error) {
        ...
        try {
            ...
            out.println("<p><a href='/Assignment3/exercise3'>Back</a>");
            out.println("</center>");
            out.println("</body>");
            out.println("</html>");
            out.close();
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            printWriter.println("<p style='text-align:center;'><a href='/Assignment3/exercise3'>Back</a></p>");
        } catch (Exception e) {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	out.print("<form action=\"exercise3\" method=\"post\">");
